jQuery(function ($) {
	...
	if(getDaysId !== null){
		...
		let countDown = new Date('October 30, 2029 00:00:00').getTime();
	...
	// Buy Now Btn
	// $('body').append("<a href='https://themeforest.net/checkout/from_item/28830804?license=regular&support=bundle_6month&_ga=2.41076965.634514020.1646539215-1425290503.1590986634' target='_blank' class='buy-now-btn'><img src='assets/img/envato.png' alt='envato'/>Buy Now</a>");
